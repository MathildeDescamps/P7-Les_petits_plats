...
const searchRecipes = (input)=>{
    ...
    let matches = _recipesJsonDefault.default.filter((recipe)=>{
                ...
                if (!document.querySelector(tagDOM)) {
                    ...
                    let doubleMatches = matches.filter((match)=>{
                        ...
                        match.ingredients.forEach(({ ingredient  })=>{
                            ...
                            if (ingredient === newIngredient.textContent) isMatching = true;
                        });
                        return isMatching;
                    });
...
},{}]},["8EXkr","l5eIm"], "l5eIm", "parcelRequirec720")
