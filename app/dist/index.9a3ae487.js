...
const search = (e)=>{
    ...
    if (ingredientsFilterInput.value === '' && appliancesFilterInput.value === '' && utensilsFilterInput.value === '' && searchbarInput.value !== '') searchWithSearchbarOnly();
...
searchbarInput.addEventListener("input", (e)=>{
    if (e.target.value.length > 2) search(e);
